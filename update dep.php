   ...
   <div class="container">
       <form action="" method="post">
         ...
         <?php 
            ...
            if(isset($_POST['submit'])){
               if(!empty($_POST['id'])&& !empty($_POST['name'])){
                  ...
                  $query= "update department set Department_Id='$id', Department_Name='$name' , Dlocation='$location' where Department_Id='" . $_GET['id'] . "'";
         ...
         ?>
          ...
          <div class="form-group">
             <label>Department Location:</label><input type="text" class="form-control" name="location"  value="<?php echo $arrdata['Dlocation']; ?>" placeholder="location" required>
          </div>
