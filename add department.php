...
if(isset($_POST['submit'])){
   if(!empty($_POST['id'])&& !empty($_POST['name'])){
       ...
       $query= "insert into department(Department_Id,Department_Name,Dlocation) values('$id','$name','$location')";
   ...
   <div class="container">
       <form action="" method="post" onclick="return myfunction()">
         ...
         ?>
          ...
          <div class="form-group">
             <label>Department Location:</label><input type="text" class="form-control" name="location" placeholder="location" required>
          </div>
